  ...
  <div class="container">
    <div class="row">
      <div class="col">
        ...
        <li class="breadcrumb-item"><a href="#">Home</a><i>&nbsp;/&nbsp;</i>Lips</nava></li>
        <div class="shop-page-header--inner">
          <div class="shop-page-header--title">
                                        <h1 class="entry-title">Category:<span>Skincare</span></h1>
...
<div class="top-banner1" style="background-image: url('img/banner8.png');">
    <div class="container">
      <div class="row">
        <div class="banner-title">
          ...
          <div class="banner-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                 <li class="breadcrumb-item"><a href="index.php">Home /  Skincare</nava></li></a>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="ti_heading_wraper">
                  <div class="big-title">
           <div class="heading">Skincare<span>Products</span></div>
          </div>
        </div>
            </div>
    </div>
        ...
        <div class="course">
          ...
          <img loading="lazy" width="350" height="400" src="hms/images/<?php echo $row['proimg'];?>" alt=" "class="attachment-wc-grid-course-thumb size-wc-grid-course-thumb wp-post-image" alt="">
            ...
            <div class="wc-course-details" style="height: ;">
             <div><a href="#" rel="tag" ><h2>Skincare</h2></a></div>
